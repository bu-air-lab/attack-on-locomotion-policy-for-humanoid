...
COBBLESTONE_ROAD_CFG = terrain_gen.TerrainGeneratorCfg(
    size=(8.0, 8.0),
    border_width=20.0,
    num_rows=10,        # 10 difficulty levels: 0° to 6°
    num_cols=20,
...
#    flat_orientation_l2 = RewTerm(func=mdp.flat_orientation_l2, weight=-5.0) # remove it for slope
   ...
   flat_orientation_l2 = RewTerm(func=mdp.flat_orientation_l2, weight=-1.0) # for slope
#    base_height = RewTerm(func=mdp.base_height_l2, weight=-10, params={"target_height": 0.78})
   base_height = RewTerm(func=mdp.base_height_l2, weight=-5, params={"target_height": 0.78, "sensor_cfg": SceneEntityCfg("height_scanner")}) # for slope
